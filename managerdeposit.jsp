...
<center> <h2>Amount to be deposited</h2><input type="text" name="amount" id="rcorners2"></center><br>
	<center> <input type="submit" name="function" value="managerdeposit" id="rcorners2"></center>
	</form>	</center> 
