...
<tr id ="rcorners2">
<td id ="rcorners2"><%=list.getAccno() %></td>
<td id ="rcorners2"><%=list.getUsername() %></td>
<td id ="rcorners2"><%=list.getBalance()%></td>
<td id ="rcorners2"><%=list.getLastvisiteddate() %></td>
</tr>
